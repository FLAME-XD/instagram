...
class instagram:
	...
	def metode(self):
		urut = []
		urut.append(Panel(f"[italic bold white] API interface",title=f"[bold red]• [bold green]01 [bold red]•",width=22,style=f"{rich_gelap}"))
		urut.append(Panel(f"[italic bold white] asynchronous",title=f"[bold red]• [bold green]02 [bold red]•",width=23,style=f"{rich_gelap}"))
		urut.append(Panel(f"[italic bold white] API interface V2",title=f"[bold red]• [bold green]03 [bold red]•",width=23,style=f"{rich_gelap}"))
		self.tol.print(Columns(urut))
		lupXfla = []
